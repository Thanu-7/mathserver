...
<style type="text/css">
body {
    background-color: rgb(144, 226, 218) ;
}
.edge {
    width: 100%;
    padding-top: 250px;
...
<div class="edge">
    <div class="box">
        ...
        <h3>Thanushree Vijayakanth(24900679)</h3>
        <form method="POST">
            {% csrf_token %}
            <div class="formelt">
...
from msapp import views  # Updated to match the new app name (mathapp)
